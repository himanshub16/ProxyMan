...
list_proxy() {
	...
	echo -e "\e[36m Authentication \e[0m" User  : $(gsettings get org.gnome.system.proxy.http authentication-user) Password : $(gsettings get org.gnome.system.proxy.http authentication-password)
